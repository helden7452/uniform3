...
export default async function Article() {
  ...
  return (
    <>
      <ArticleHero
        title="Aviation Uniform Fabrics Altitude"
        image={{
          src: '/images/aviation-uniforms/aviation-uniform-fabrics-altitude.jpg',
          alt: 'Aviation Uniform Fabrics Altitude',
          width: 1024,
          height: 576,
        }} />
      ...
      <Container className="mt-8 sm:mt-10 lg:mt-12">
        <ArticleBreadcrumb
          breadcrumbs={[
            ...
            { label: 'Aviation Uniform Fabrics Altitude', href: '/blog/aviation-uniform-fabrics-altitude', isCurrent: true }
          ]}
        />
      </Container>
            ...
            <ArticleBody className="lg:w-2/3">
              <MDXProvider>
                <div className="prose prose-slate max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-lead:text-slate-500 prose-a:font-semibold prose-a:underline">
                  <h2 className="text-xl font-bold mb-6">Aviation Uniform Fabrics Altitude</h2>
            ...
            <aside className="lg:w-1/3 space-y-8">
              ...
              <div className="bg-primary-50 p-6 rounded-xl shadow-sm">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="/aviation-uniforms" className="flex items-center text-primary hover:text-primary-dark">
                      <span className="ml-2">⟨</span>
                      <span>/aviation-uniforms</span>
                    </a>
                  </li>
                </ul>
              </div>
