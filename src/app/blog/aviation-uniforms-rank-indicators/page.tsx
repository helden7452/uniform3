...
export default async function Article() {
  ...
  return (
    <>
      <ArticleHero
        title="مؤشرات الرتب في أزياء الطيران"
        image={{
          src: '/images/aviation-uniforms/aviation-uniforms-rank-indicators.jpg',
          alt: 'مؤشرات الرتب في أزياء الطيران',
          width: 1024,
          height: 576,
        }} />
      ...
      <Container className="mt-8 sm:mt-10 lg:mt-12">
        <ArticleBreadcrumb
          breadcrumbs={[
            ...
            { label: 'مؤشرات الرتب في أزياء الطيران', href: '/blog/aviation-uniforms-rank-indicators', isCurrent: true }
          ]}
        />
      </Container>
            ...
            <ArticleBody className="lg:w-2/3">
              <MDXProvider>
                <div className="prose prose-slate max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-lead:text-slate-500 prose-a:font-semibold prose-a:underline">
                  <h2 className="text-xl font-bold mb-6">مؤشرات الرتب في أزياء الطيران</h2>
