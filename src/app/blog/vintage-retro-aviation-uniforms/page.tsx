...
export default async function Article() {
  ...
  return (
    <>
      <ArticleHero
        title="أزياء الطيران الكلاسيكية والتراثية"
        image={{
          src: '/images/aviation-uniforms/vintage-retro-aviation-uniforms.jpg',
          alt: 'أزياء الطيران الكلاسيكية والتراثية',
          width: 1024,
          height: 576,
        }} />
      ...
      <Container className="mt-8 sm:mt-10 lg:mt-12">
        <ArticleBreadcrumb
          breadcrumbs={[
            ...
            { label: 'أزياء الطيران الكلاسيكية والتراثية', href: '/blog/vintage-retro-aviation-uniforms', isCurrent: true }
          ]}
        />
      </Container>
            ...
            <ArticleBody className="lg:w-2/3">
              <MDXProvider>
                <div className="prose prose-slate max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-lead:text-slate-500 prose-a:font-semibold prose-a:underline">
                  <h2 className="text-xl font-bold mb-6">أزياء الطيران الكلاسيكية والتراثية</h2>
